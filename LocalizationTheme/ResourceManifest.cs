...
namespace OrchardCore.Themes.LocalizationTheme
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                .DefineScript("LocalizationTheme-vendor-jQuery")
                .SetUrl("~/LocalizationTheme/vendor/jquery/jquery.min.js", "~/LocalizationTheme/vendor/jquery/jquery.js")
            ...
            manifest
                .DefineScript("LocalizationTheme-vendor-jQuery.slim")
                .SetUrl("~/LocalizationTheme/vendor/jquery/jquery.slim.min.js", "~/LocalizationTheme/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("LocalizationTheme-vendor-bootstrap")
                .SetDependencies("LocalizationTheme-vendor-jQuery")
                .SetUrl("~/LocalizationTheme/vendor/bootstrap/js/bootstrap.min.js", "~/LocalizationTheme/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                .DefineScript("LocalizationTheme-vendor-bootstrap-bundle")
                .SetDependencies("LocalizationTheme-vendor-jQuery")
                .SetUrl("~/LocalizationTheme/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/LocalizationTheme/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                .DefineStyle("LocalizationTheme-vendor-bootstrap")
                .SetUrl("~/LocalizationTheme/vendor/bootstrap/css/bootstrap.min.css", "~/LocalizationTheme/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                .DefineScript("LocalizationTheme-vendor-font-awesome")
